...
wk.register({
  ...
  ["<leader>b"] = {
    name = "+Buffers",
    a = { '<cmd> lua require("bufferline").go_to(1, true)<cr>', "Go to buffer 1"},
    b = { '<cmd> lua require("bufferline").go_to(2, true)<cr>', "Go to buffer 2"},
    c = { '<cmd> lua require("bufferline").go_to(3, true)<cr>', "Go to buffer 3"},
    d = { '<cmd> lua require("bufferline").go_to(4, true)<cr>', "Go to buffer 4"},
    e = { '<cmd> lua require("bufferline").go_to(5, true)<cr>', "Go to buffer 5"},
    f = { '<cmd> lua require("bufferline").go_to(6, true)<cr>', "Go to buffer 6"},
    g = { '<cmd> lua require("bufferline").go_to(7, true)<cr>', "Go to buffer 7"},
    h = { '<cmd> lua require("bufferline").go_to(8, true)<cr>', "Go to buffer 8"},
    i = { '<cmd> lua require("bufferline").go_to(9, true)<cr>', "Go to buffer 9"},
    j = { '<cmd> lua require("bufferline").go_to(-1, true)<cr>', "Go to last buffer"},
  },
  ["<leader>d"] = {
    name = "+Diagnostics",
