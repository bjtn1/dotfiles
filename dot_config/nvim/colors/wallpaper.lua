...
-- Source of truth: ~/.cache/wal/colors.json, regenerated by
-- ~/.config/scripts/apply-pywal-colorscheme every time the wallpaper changes
-- (SUPER+W). Re-run `:colorscheme wallpaper` after changing wallpapers to
-- pick up the new palette -- this file is re-read from disk every time.
