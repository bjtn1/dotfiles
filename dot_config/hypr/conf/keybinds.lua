...
hl.bind("SUPER + Tab", hl.dsp.window.alter_zorder({ mode = "top" }), { description = "Bring window to top" })

hl.bind("SUPER + K", hl.dsp.layout("swapsplit"), { description = "Swap split halves" })
...
for i = 1, 9 do
  hl.bind(mainMod .. " + " .. i, hl.dsp.focus({ workspace = i }), { description = "Go to workspace " .. i })
...
hl.bind(mainMod .. " + SHIFT + right", hl.dsp.window.move({ workspace = "+1" }), { description = "Move window to next workspace" })
hl.bind(mainMod .. " + SHIFT + left", hl.dsp.window.move({ workspace = "-1" }), { description = "Move window to previous workspace" })
...
hl.bind(mainMod .. " + mouse:272", hl.dsp.window.drag(), { mouse = true, description = "Drag-move window" })
hl.bind(mainMod .. " + mouse:273", hl.dsp.window.resize(), { mouse = true, description = "Drag-resize window" })

-- Laptop multimedia keys for volume and LCD brightness
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+"), { repeating = true, locked = true, description = "Volume up" })
...
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"), { repeating = true, locked = true, description = "Mute" })
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"), { repeating = true, locked = true, description = "Mute mic" })
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightnessctl s 10%+"), { description = "Brightness up" })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl s 10%-"), { description = "Brightness down" })
hl.bind("F6", hl.dsp.exec_cmd("brightnessctl s 10%+"), { description = "Brightness up" })
hl.bind("F5", hl.dsp.exec_cmd("brightnessctl s 10%-"), { description = "Brightness down" })
