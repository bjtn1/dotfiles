-- src = https://github.com/mylinuxforwork/dotfiles/blob/main/share/dotfiles/.config/hypr/conf/animations/default.conf
-- name "End-4"
...
hl.animation({ leaf = "layersOut", enabled = true, speed = 3, bezier = "menu_decel", style = "slide" })
